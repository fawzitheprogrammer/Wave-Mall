...
class MostSearchingProductListView extends StatefulWidget {
  ...
  @override
  State<MostSearchingProductListView> createState() =>
      _MostSearchingProductListViewState();
}

class _MostSearchingProductListViewState
    extends State<MostSearchingProductListView> {
    ...
    return Scaffold(
      ...
      body: Consumer<ProductProvider>(builder: (context, productProvider, _) {
        return (productProvider.mostSearchingProduct != null &&
                productProvider.mostSearchingProduct!.products != null)
            ? productProvider.mostSearchingProduct!.products!.isNotEmpty
                ? SingleChildScrollView(
                    controller: scrollController,
                    child: PaginatedListView(
                      scrollController: scrollController,
                      totalSize:
                          productProvider.mostSearchingProduct!.totalSize,
                      offset: (productProvider.mostSearchingProduct != null &&
                              productProvider.mostSearchingProduct!.offset !=
                                  null)
