...
class RefundBottomSheet extends StatefulWidget {
  ...
  const RefundBottomSheet(
      {super.key, required this.product, required this.orderDetailsId});
...
class RefundBottomSheetState extends State<RefundBottomSheet> {
  ...
  Widget build(BuildContext context) {
    Provider.of<OrderProvider>(context, listen: false)
        .getRefundReqInfo(widget.orderDetailsId);
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text(getTranslated('refund_request', context)!,
            ...
            child: Column(
                ...
                children: [
                  Consumer<OrderProvider>(builder: (context, refund, _) {
                    return (refund.refundInfoModel != null &&
                            refund.refundInfoModel!.refund != null)
                        ? Padding(
                                        ...
                                        Padding(
                                            ...
                                            child: TitleWithAmountRow(
                                                title: getTranslated(
                                                    ...
                                                    context)!,
                                                amount:
                                                    '-${PriceConverter.convertPrice(context, refund.refundInfoModel!.refund!.productTotalDiscount)}')),
                                        TitleWithAmountRow(
                                            title:
