...
import 'package:wave_mall_user/features/shop/view/shop_screen.dart';
                                  ...
                                  onTap: () => Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (_) => TopSellerProductScreen(
                                              sellerId: seller
                                                  .sellerModel?.seller?.id,
                                              temporaryClose: seller
                                                      .sellerModel
                                                      ?.seller
                                                      ?.shop
                                                      ?.temporaryClose ??
                                                  false,
                                              vacationStatus: seller
                                                      .sellerModel
                                                      ?.seller
                                                      ?.shop
                                                      ?.vacationStatus ??
                                                  false,
                                              vacationEndDate: seller
                                                  .sellerModel
                                                  ?.seller
                                                  ?.shop
                                                  ?.vacationEndDate,
                                    ...
                                    children: [
                                      Text(
                                        NumberFormat.compact().format(
                                            seller.sellerModel!.totalProduct),
                                        style: titilliumSemiBold.copyWith(
                                            fontSize:
                                                Dimensions.fontSizeExtraLarge),
                                      ),
                        ...
                        onTap: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (_) => TopSellerProductScreen(
                                    ...
                                    temporaryClose: seller.sellerModel?.seller
                                        ?.shop?.temporaryClose,
                                    vacationStatus: seller.sellerModel?.seller
                                        ?.shop?.vacationStatus,
                                    vacationEndDate: seller.sellerModel?.seller
