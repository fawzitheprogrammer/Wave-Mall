...
import 'package:wave_mall_user/features/home/shimmer/recommended_product_shimmer.dart';
          ...
          Consumer<ProductProvider>(
            builder: (context, recommended, child) {
              ...
              return recommended.recommendedProduct != null
                  ? recommended.recommendedProduct!.name != null
                      ? InkWell(
                          onTap: () {
                            Navigator.push(
                                context,
                                                                  ...
                                                                  .copyWith(
                                                                      fontSize:
                                                                          Dimensions
                                                                              .fontSizeDefault)),
                                                          Text(
                                                              '(${recommended.recommendedProduct?.reviewCount.toString()})',
