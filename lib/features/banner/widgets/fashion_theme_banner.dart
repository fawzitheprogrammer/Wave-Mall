...
import 'package:wave_mall_user/features/banner/widgets/banner_shimmer.dart';
                        ...
                        SizedBox(
                            ...
                            child: CarouselSlider.builder(
                              ...
                              itemBuilder: (context, index, _) {
                                String colorString = bannerController
                                            .mainBannerList![index]
                                            .backgroundColor !=
                                        null
                                    ? '0xff${bannerController.mainBannerList![index].backgroundColor!.substring(1, 7)}'
                                    : '0xFF424242';
              ...
              Positioned(
                  ...
                  child: Row(
                      ...
                      children: bannerController.mainBannerList!.map((banner) {
                        int index =
                            bannerController.mainBannerList!.indexOf(banner);
