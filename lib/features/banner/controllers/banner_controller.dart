...
import 'package:wave_mall_user/features/banner/domain/models/banner_model.dart';
                ...
                builder: (_) => TopSellerProductScreen(
                    ...
                    vacationStartDate:
                        Provider.of<TopSellerProvider>(context, listen: false)
                            ...
                            .shop
                            ?.vacationStartDate,
                    name: Provider.of<TopSellerProvider>(context, listen: false)
                        .topSellerList?[tIndex]
                        .shop
                        ?.name,
                    banner:
                        Provider.of<TopSellerProvider>(context, listen: false)
                            ...
                            .shop
                            ?.banner,
                    image: Provider.of<TopSellerProvider>(context, listen: false)
                        .topSellerList?[tIndex]
                        .shop
                        ?.image)));
      }
