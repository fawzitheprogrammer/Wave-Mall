...
import 'package:wave_mall_user/features/home/widget/shop_again_from_recent_store_card.dart';
...
class ShopAgainFromYourRecentStore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<ProductProvider>(builder: (context, shopAgainProvider, _) {
      return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return ShopAgainFromRecentStoreCard(
