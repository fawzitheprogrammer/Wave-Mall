                                  ...
                                  onTap: () {
                                    showDialog(
                                        ...
                                        builder: (_) => ImageDialog(
                                            imageUrl:
                                                '${Provider.of<SplashProvider>(context, listen: false).configModel?.baseUrls?.productThumbnailUrl}/${orders.details?[detailsIndex].product?.thumbnail ?? ''}'));
                                  },
                                  child: CustomImage(
                                      fit: BoxFit.cover,
                                      width: 45,
                  ...
                  children: [
                    Expanded(
                      ...
                      children: [
                        ...
                        Text(
                            "Final Total : ${PriceConverter.convertPrice(context, orders.orderAmount)}",
                            style: robotoBold.copyWith(
                        ...
                        child: CustomButton(
                            ...
                            onTap: () {
                              Provider.of<OrderProvider>(context, listen: false)
                                  .reorder(orderId: orders.id.toString());
                            })),
                  ],
                ),
              ],
