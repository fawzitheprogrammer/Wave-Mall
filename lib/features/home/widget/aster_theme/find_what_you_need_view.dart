  ...
  Widget build(BuildContext context) {
    return Consumer<ProductProvider>(builder: (context, productProvider, _) {
      return productProvider.findWhatYouNeedModel != null
          ? (productProvider.findWhatYouNeedModel!.findWhatYouNeed != null &&
                  productProvider
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                          '${productProvider.findWhatYouNeedModel!.findWhatYouNeed![index].name}',
                                      ...
                                      Text(
                                          '${productProvider.findWhatYouNeedModel!.findWhatYouNeed![index].productCount} ${getTranslated('products', context)}',
                                          style: textRegular.copyWith(
                                              color:
                                                    ...
                                                    children: [
                                                      ClipRRect(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: CustomImage(
                                                            fit: BoxFit.cover,
                                                            image:
                                                                '${Provider.of<SplashProvider>(context, listen: false).configModel?.baseUrls?.categoryImageUrl}/${productProvider.findWhatYouNeedModel!.findWhatYouNeed![index].childes?[subIndex].icon}',
                                                          ),
                                                        ),
                                                      ),
                                                      const SizedBox(
                                                      ...
                                                      SizedBox(
                                                        width: MediaQuery.of(
                                                            ...
                                                            7,
                                                        child: Text(
                                                          '${productProvider.findWhatYouNeedModel!.findWhatYouNeed![index].childes?[subIndex].name}',
                                                          maxLines: 1,
