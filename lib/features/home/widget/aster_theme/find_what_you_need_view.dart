                                        ...
                                        return InkWell(
                                          ...
                                          child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              ClipRRect(borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),
                                                child: Container(width: MediaQuery.of(context).size.width/10, height: MediaQuery.of(context).size.width/10,
                                                  decoration: BoxDecoration(
                                              ...
                                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                               ...
                                               SizedBox(width: MediaQuery.of(context).size.width/7,
                                                child: Text('${productProvider.findWhatYouNeedModel!.findWhatYouNeed![index].childes?[subIndex].name}', maxLines: 1,overflow: TextOverflow.ellipsis,
