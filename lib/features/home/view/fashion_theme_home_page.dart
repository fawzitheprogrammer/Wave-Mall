...
import 'package:wave_mall_user/features/deal/view/featured_deal_screen.dart';
import 'package:wave_mall_user/features/home/shimmer/featured_product_shimmer.dart';
import 'package:wave_mall_user/features/home/widget/announcement.dart';
import 'package:wave_mall_user/features/home/widget/aster_theme/find_what_you_need_shimmer.dart';
import 'package:wave_mall_user/features/home/widget/aster_theme/more_store_view.dart';
import 'package:wave_mall_user/features/home/widget/cart_widget_home_page.dart';
import 'package:wave_mall_user/features/category/widget/category_view.dart';
import 'package:wave_mall_user/features/home/widget/fashion_theme/most_demanded_product.dart';
import 'package:wave_mall_user/features/home/widget/fashion_theme/shop_again_from_your_recent_store.dart';
import 'package:wave_mall_user/features/banner/widgets/fashion_theme_banner.dart';
import 'package:wave_mall_user/features/deal/widget/featured_deal_view.dart';
import 'package:wave_mall_user/features/product/widget/featured_product_view.dart';
import 'package:wave_mall_user/features/home/shimmer/flash_deal_shimmer.dart';
import 'package:wave_mall_user/features/deal/widget/flash_deals_view.dart';
import 'package:wave_mall_user/features/banner/widgets/single_banner.dart';
import 'package:wave_mall_user/features/home/widget/just_for_you/just_for_you.dart';
import 'package:wave_mall_user/features/product/widget/latest_product_view.dart';
import 'package:wave_mall_user/features/shop/widget/more_store_list_view.dart';
import 'package:wave_mall_user/features/product/widget/most_searching_product_list_view.dart';
import 'package:wave_mall_user/features/product/widget/products_view.dart';
import 'package:wave_mall_user/features/deal/view/flash_deal_screen.dart';
import 'package:wave_mall_user/features/product/widget/recommended_product_view.dart';
import 'package:wave_mall_user/features/home/widget/search_widget_home_page.dart';
import 'package:wave_mall_user/features/home/widget/shop_again_from_recent_store_list_view.dart';
...
import 'package:wave_mall_user/features/product/view/view_all_product_screen.dart';
import 'package:wave_mall_user/features/search/search_screen.dart';
import 'package:wave_mall_user/features/shop/view/all_shop_screen.dart';
...
class _FashionThemeHomePageState extends State<FashionThemeHomePage> {
  ...
  Future<void> _loadData(bool reload) async {
    ...
    await Provider.of<SellerProvider>(Get.context!, listen: false)
        .getMoreStore();
                  ...
                  children: [
                    ...
                    const Padding(
                        padding: EdgeInsets.fromLTRB(
                            0, 0, 0, Dimensions.homePagePadding),
                    ...
                    Consumer<ProductProvider>(
                      ...
                      return (productProvider.mostSearchingProduct != null &&
                              productProvider.mostSearchingProduct!.products !=
                                  null &&
                              productProvider
                              ...
                              children: [
                                TitleRow(
                                    ...
                                    onTap: () => Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (_) =>
                                                const MostSearchingProductListView()))),
                                JustForYouView(
                            ...
                            ? Padding(
                                ...
                                child: Column(
                                  children: [
                                    TitleRow(
                                        title: getTranslated(
                                            'shop_again_from_recent_store',
                                            context),
                                        onTap: () => Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (_) =>
                                                    const ShopAgainFromYourRecentStoreView()))),
                                    const SizedBox(
                                        height: 160,
                            ...
                            return Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: ListView.builder(
                                    shrinkWrap: true,
                                    itemCount:
                                        productProvider.productTypeList.length,
                                    scrollDirection: Axis.horizontal,
                                    padding: EdgeInsets.zero,
                                    itemBuilder: (context, index) {
                                      return InkWell(
                                        onTap: () =>
                                            productProvider.changeTypeOfProduct(
                                                productProvider
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  border: Border.all(
                                                      ...
                                                      color: index ==
                                                          ...
                                                          : Theme.of(context)
                                                              .cardColor)),
                                              child: Center(child: Text('${getTranslated(productProvider.productTypeList[index].title!, context)}', style: textMedium.copyWith(color: index == productProvider.selectedProductTypeIndex ? Theme.of(context).colorScheme.tertiary : Theme.of(context).hintColor)))),
                                        ),
                                      );
                                    }),
                              ),
