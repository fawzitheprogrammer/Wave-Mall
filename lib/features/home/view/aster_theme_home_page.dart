...
import 'package:wave_mall_user/features/home/shimmer/order_again_shimmer.dart';
import 'package:wave_mall_user/features/home/shimmer/top_store_shimmer.dart';
...
import 'package:wave_mall_user/features/home/widget/aster_theme/find_what_you_need_view.dart';
import 'package:wave_mall_user/features/home/widget/aster_theme/more_store_view.dart';
import 'package:wave_mall_user/features/home/widget/aster_theme/order_again_view.dart';
import 'package:wave_mall_user/features/banner/widgets/banners_view.dart';
...
import 'package:wave_mall_user/features/product/widget/home_category_product_view.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Consumer<ProductProvider>(
                      ...
                      return productProvider.findWhatYouNeedModel != null
                          ? (productProvider.findWhatYouNeedModel!
                                          .findWhatYouNeed !=
                                      null &&
                                  productProvider.findWhatYouNeedModel!
                    ...
                    singleVendor
                        ...
                        : Consumer<TopSellerProvider>(
                            ...
                            return sellerProvider.topSellerList != null
                                ? sellerProvider.topSellerList!.isNotEmpty
                                    ? Column(children: [
                                        TitleRow(
                                            title: getTranslated(
                                                'top_stores', context),
                    ...
                    SizedBox(child: Consumer<ProductProvider>(
                        builder: (context, productProvider, _) {
                      return (productProvider.justForYouProduct != null &&
                              productProvider.justForYouProduct!.isNotEmpty)
                          ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                TitleRow(
                                ...
                                JustForYouView(
                                    productList:
                                        productProvider.justForYouProduct),
                              ],
                            )
                          : const SizedBox();
                    })),
                          ...
                          ? Padding(
                              ...
                              child: Column(
                                children: [
                                  TitleRow(
                                      title:
                                          getTranslated('more_store', context),
                                      onTap: () => Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (_) =>
