...
import 'package:wave_mall_user/basewidget/remove_wish_list_bottom_sheet.dart';
import 'package:wave_mall_user/features/compare/widget/custom_top_sheet.dart';
import 'package:wave_mall_user/features/search/widget/partial_matched.dart';
...
class _CompareProductScreenState extends State<CompareProductScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CompareProvider>(builder: (context, compareProvider, _) {
        return Column(
          children: [
            if (compareProvider.compareModel != null &&
                compareProvider.compareModel!.compareLists != null &&
                compareProvider.compareModel!.compareLists!.isNotEmpty)
              InkWell(
                  onTap: () => showModalBottomSheet(
                      context: context,
                      builder: (_) => const RemoveFromCompareListBottomSheet()),
                  child: Padding(
                      padding:
                      ...
                      child: Row(
                          ...
                          children: [
                            const SizedBox(),
                            Text('${getTranslated('clear_all', context)}',
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: ListView.builder(
                                shrinkWrap: true,
                                itemCount:
                                    compareProvider.attributeList?.length,
                                ...
                                itemBuilder: (context, index) {
                                  return Container(
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          Text(
                                              '${compareProvider.attributeList?[index].name}')
                                        ]),
                                  );
                                })),
                        Container(
                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          (compareProvider.compareModel != null &&
                                  compareProvider.compareModel!.compareLists !=
                                      null &&
                                  compareProvider
                                      .compareModel!.compareLists!.isNotEmpty)
                              ? SizedBox(
                                  width: Dimensions.compareCardWidget,
                                  child: CompareCard(
                                      compareId: compareProvider
                                          .compareModel?.compareLists?[0].id,
                                      product: compareProvider.compareModel
                                          ?.compareLists?[0].product))
                              : const SizedBox(
                                  width: Dimensions.compareCardWidget,
                                  child: CompareCard(product: null)),
                          (compareProvider.compareModel != null &&
                                  compareProvider.compareModel!.compareLists !=
                                      null &&
                                  compareProvider
                                          .compareModel!.compareLists!.length >
                                      1)
                              ? SizedBox(
                                  width: Dimensions.compareCardWidget,
                                  child: CompareCard(
                                      compareId: compareProvider
                                          .compareModel?.compareLists?[1].id,
                                      product: compareProvider.compareModel
                                          ?.compareLists?[1].product))
                              : const SizedBox(
                                  width: Dimensions.compareCardWidget,
                                  child: CompareCard(product: null)),
                          (compareProvider.compareModel != null &&
                              ...
                              ? SizedBox(
                                  ...
                                  child: CompareCard(
                                      compareId: compareProvider
                                          .compareModel?.compareLists?[2].id,
                                      product: compareProvider.compareModel
                                          ?.compareLists?[2].product))
                              : const SizedBox(
                                  width: Dimensions.compareCardWidget,
                                  child: CompareCard(product: null)),
                        ],
...
class CompareCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<CompareProvider>(builder: (context, compareProvider, _) {
      return Padding(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                                ...
                                child: CustomImage(
                                    ...
                                    height: 180,
                                    width: 200,
                                    placeholder: Images.emptyProduct)),
                          ),
                        ),
                        Positioned(
                            right: 10,
                          ...
                          ? product!.colors!.isNotEmpty
                              ? Center(
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      String colorString =
                                          '0xff${product!.colors![index].code!.substring(1, 7)}';
                                      return Center(
                                        child: Container(
                                          decoration: BoxDecoration(
                              ...
                              : const Center(
                                  child: SizedBox(
                                      height: 48,
                                      width: 200,
                                      child: Center(child: Text('No Color'))))
                          : const SizedBox(),
                    ),
                    SizedBox(
                        width: 200,
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (product != null &&
                                ...
                                for (int i = 0;
                                    i < compareProvider.attributeList!.length;
                                    i++) {
                                  bool foundMatch = false;

                                  for (int j = 0;
                                      j < product!.choiceOptions!.length;
                                      j++) {
                                    if (compareProvider
                                            .attributeList![i].name ==
                                        product!.choiceOptions![j].title) {
                                      variation.add(
                                          product!.choiceOptions![j].options!);
                                      foundMatch = true;
                                  ...
                                  if (!foundMatch) {
                                    variation.add([
                                      'No ${compareProvider.attributeList![i].name}'
                                    ]);
                                  }
                                }
                              }
                              ...
                              return (product != null &&
                                  ...
                                  : Center(
                                      child: SizedBox(
                                          ...
                                          child: Center(
                                              child: Text(
                                                  'No ${compareProvider.attributeList![index].name}'))));
                            })),
                    Container(
                        height: 48,
                        decoration: BoxDecoration(
