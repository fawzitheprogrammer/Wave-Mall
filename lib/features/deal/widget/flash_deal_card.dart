...
class FlashDealCard extends StatelessWidget {
  ...
  const FlashDealCard(
      ...
      required this.megaProvider,
      required this.index});

  @override
  Widget build(BuildContext context) {
    var splashController = Provider.of<SplashProvider>(context, listen: false);
              ...
              Padding(
                  ...
                  child: Container(
                      ...
                      child: ClipRRect(
                          ...
                          child: CustomImage(
                              image:
                                  '${splashController.baseUrls!.productThumbnailUrl}'
                                  '/${product.thumbnail}')))),
              if (product.currentStock! < product.minimumOrderQuantity! &&
