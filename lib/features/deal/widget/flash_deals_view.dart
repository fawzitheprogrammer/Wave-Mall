...
import 'package:wave_mall_user/features/deal/widget/flash_deal_card.dart';
    ...
    return isHomeScreen
        ? Consumer<FlashDealProvider>(
            builder: (context, megaProvider, child) {
              return megaProvider.flashDeal != null
                  ? megaProvider.flashDealList.isNotEmpty
                                          ...
                                          children: [
                                            ...
                                            Row(children: [
                                              ...
                                              Icon(Icons.star,
                                                  ...
                                                  size: 15),
                                              Text(
                                                  '(${megaProvider.flashDealList[index].reviewCount.toString()})',
                                                  style: textRegular.copyWith(
                                                    fontSize: Dimensions
                                                        .fontSizeSmall,
                                                  )),
