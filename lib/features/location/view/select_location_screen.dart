...
import 'package:wave_mall_user/features/location/widget/location_search_dialog.dart';
                ...
                ? InkWell(
                    ...
                    child: Container(
                        ...
                        child: Row(children: [
                          Expanded(
                              child: Text(
                                  locationController.pickAddress!.name != null
                    ...
                    children: [
                      InkWell(
                          onTap: () => locationController.getCurrentLocation(
                              context, false, mapController: _controller),
                          child: Container(
                              width: 50,
                              height: 50,
