      ...
      return Container(
        ...
        child: Column(
            ...
            children: [
              ...
              couponProvider.availableCouponList != null
                  ? couponProvider.availableCouponList!.isNotEmpty
                      ? Expanded(
                          child: Padding(
                            padding: const EdgeInsets.only(
                                bottom: Dimensions.paddingSizeDefault),
                            child: ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount:
                                    couponProvider.availableCouponList!.length,
                                itemBuilder: (context, index) {
                                  return CouponItem(
                                      coupons: couponProvider
                                          .availableCouponList![index],
                                      fromCheckout: true);
                                }),
                          ),
                        )
