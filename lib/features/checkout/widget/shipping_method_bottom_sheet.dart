...
class ShippingMethodBottomSheet extends StatefulWidget {
  ...
  @override
  ShippingMethodBottomSheetState createState() =>
      ShippingMethodBottomSheetState();
}
...
class ShippingMethodBottomSheetState extends State<ShippingMethodBottomSheet> {
  ...
  @override
  void initState() {
    if (Provider.of<CartController>(context, listen: false).shippingList !=
            null &&
        Provider.of<CartController>(context, listen: false)
            .shippingList!
            .isNotEmpty) {
      selectedIndex = Provider.of<CartController>(context, listen: false)
              ...
              child: Consumer<CartController>(
                builder: (context, order, child) {
                  return (order.shippingList != null &&
                          order.shippingList!.isNotEmpty &&
                          order.shippingList![widget.sellerIndex]
                                  .shippingMethodList !=
                              null)
                      ? (order.shippingList![widget.sellerIndex]
                                              ...
                                              child: Padding(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Text(
                                                          '${order.shippingList![widget.sellerIndex].shippingMethodList![index].title} (Duration ${order.shippingList![widget.sellerIndex].shippingMethodList![index].duration})'),
                                                    ),
                                                    const SizedBox(
                                                        width: Dimensions
                                                            .paddingSizeSmall),
