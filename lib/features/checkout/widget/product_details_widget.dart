  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
          ...
          itemCount: Provider.of<CartController>(context, listen: false)
              .cartList
              .length,
                ...
                Expanded(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          Text(
                              '${getTranslated('qty', context)} -  ${Provider.of<CartController>(context, listen: false).cartList[index].quantity}',
                              style: titilliumRegular.copyWith()),
                        ]),
                      ]),
                ),
