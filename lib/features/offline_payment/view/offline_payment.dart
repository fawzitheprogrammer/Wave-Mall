...
import 'package:wave_mall_user/features/checkout/widget/proced_button.dart';
import 'package:wave_mall_user/features/checkout/widget/shipping_details_widget.dart';
import 'package:wave_mall_user/features/offline_payment/widget/offline_card.dart';
...
class OfflinePaymentScreen extends StatefulWidget {
  ...
  const OfflinePaymentScreen(
      {super.key, required this.payableAmount, required this.callback});
...
class _OfflinePaymentScreenState extends State<OfflinePaymentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CheckOutProvider>(builder: (context, checkoutProvider, _) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                          '${getTranslated('offline_payment_helper_text', context)}',
                      ...
                      SizedBox(
                          ...
                          child: ListView.builder(
                              ...
                              itemCount: checkoutProvider
                                  .offlinePaymentModel!.offlineMethods!.length,
                              itemBuilder: (context, index) {
                                return InkWell(
                                    ...
                                    child: OfflineCard(
                                        offlinePaymentModel: checkoutProvider
                                            .offlinePaymentModel!
                                            .offlineMethods![index],
                                        index: index));
                              })),
                    Center(
                        child: Padding(
                    ...
                    ListView.builder(
                        ...
                        itemCount: checkoutProvider
                            .offlinePaymentModel!
                            .offlineMethods![
                                checkoutProvider.offlineMethodSelectedIndex]
                            .methodInformations
                            ?.length,
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: CustomTextField(
                              ...
                              required: checkoutProvider
                                  ...
                                  1,
                              labelText:
                                  '${checkoutProvider.offlinePaymentModel!.offlineMethods![checkoutProvider.offlineMethodSelectedIndex].methodInformations?[index].customerInput}'
                                      .replaceAll('_', ' ')
                                      .capitalize(),
                              hintText:
                                  '${checkoutProvider.offlinePaymentModel!.offlineMethods![checkoutProvider.offlineMethodSelectedIndex].methodInformations?[index].customerPlaceholder}'
                                      .replaceAll('_', ' ')
                                      .capitalize(),
                            ),
                          );
              ...
              return InkWell(
                  onTap: () {
                    ...
                    if (emptyRequiredField) {
                      showCustomSnackBar(
                          '${getTranslated('fill_all_required_fill', context)}',
                          context);
                    } else {
                      ...
                      String billingAddressId =
                          (Provider.of<SplashProvider>(context, listen: false)
                              ...
                              ? locationProvider
                                  .billingAddressList[
                                      checkoutProvider.billingAddressIndex!]
                                  .id
                                  .toString()
                              : '';
