...
import 'package:wave_mall_user/features/category/domain/model/category_model.dart';
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          onTap: () => Provider.of<CategoryController>(context,
                                  listen: false)
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (index == 0) {
                        return Ink(
                          color: Theme.of(context).highlightColor,
                          child: ListTile(
                            title: Text(getTranslated('all_products', context)!,
