...
import 'package:flutter_sixvalley_ecommerce/features/cart/widget/cart_page_shimmer.dart';
import 'package:flutter_sixvalley_ecommerce/features/cart/widget/cart_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/checkout/view/checkout_screen.dart';
import 'package:flutter_sixvalley_ecommerce/features/checkout/widget/shipping_method_bottom_sheet.dart';
...
class CartScreenState extends State<CartScreen> {
  Future<void> _loadData() async{
    await Provider.of<CartController>(Get.context!, listen: false).getCartDataAPI(Get.context!);
     Provider.of<CartController>(Get.context!, listen: false).setCartData();
      if( Provider.of<SplashProvider>(Get.context!,listen: false).configModel!.shippingMethod != 'sellerwise_shipping'){
        Provider.of<CartController>(Get.context!, listen: false).getAdminShippingMethodList(Get.context!);
      }
  }
                ...
                Expanded(child: RefreshIndicator(
                    onRefresh: () async {
                      if(Provider.of<AuthController>(context, listen: false).isLoggedIn()) {
                        await Provider.of<CartController>(context, listen: false).getCartDataAPI(context);
                      }
                      },
