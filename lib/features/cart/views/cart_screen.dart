...
import 'package:wave_mall_user/features/cart/domain/models/cart_model.dart';
...
import 'package:wave_mall_user/basewidget/not_logged_in_bottom_sheet.dart';
import 'package:wave_mall_user/basewidget/show_custom_snakbar.dart';
import 'package:wave_mall_user/features/cart/widget/cart_page_shimmer.dart';
import 'package:wave_mall_user/features/cart/widget/cart_widget.dart';
import 'package:wave_mall_user/features/checkout/view/checkout_screen.dart';
import 'package:wave_mall_user/features/checkout/widget/shipping_method_bottom_sheet.dart';
      ...
      return Consumer<CartController>(builder: (context, cart, child) {
        ...
        return Scaffold(
          bottomNavigationBar: (!cart.isXyz && cartList.isNotEmpty)
              ? Consumer<SplashProvider>(builder: (context, configProvider, _) {
                  return Container(
                      height: cartList.isNotEmpty ? 130 : 0,
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  for (int index = 0;
                                    ...
                                    for (CartModel cart
                                        in cartProductList[index]) {
                                      total += (cart.price! - cart.discount!) *
                                              cart.quantity! +
                                          tax +
                                          shippingAmount;
                                      if (total <
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child: Text(
                                                                              ...
                                                                              style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Provider.of<ThemeProvider>(context, listen: false).darkTheme ? Theme.of(context).hintColor : Theme.of(context).colorScheme.tertiary)),
                                                                        ),
                                                                        Padding(
                                                                            padding:
                                                                                const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall),
                                                                            child: Text('(${cartProductList[index].length})', style: textBold.copyWith(color: Provider.of<ThemeProvider>(context, listen: false).darkTheme ? Theme.of(context).hintColor : Theme.of(context).colorScheme.tertiary, fontSize: Dimensions.fontSizeLarge))),
                                                                      ]))),
                                                          SizedBox(
                                                            width: 200,
