...
class _SupportConversationScreenState extends State<SupportConversationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<SupportTicketProvider>(builder: (context, support, child) {
        return Column(children: [
          Expanded(child: Consumer<SupportTicketProvider>(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          if (support.supportReplyList![index].attachment !=
                                  null &&
                              support.supportReplyList![index].attachment!
                                  .isNotEmpty)
                                        ...
                                        return InkWell(
                                          onTap: () => showDialog(
                                              ...
                                              builder: (ctx) => ImageDialog(
                                                  imageUrl:
                                                      '${AppConstants.baseUrl}/storage/app/public/support-ticket/${support.supportReplyList![index].attachment?[attachmentIndex]}')),
                                          child: ClipRRect(
                                              borderRadius:
