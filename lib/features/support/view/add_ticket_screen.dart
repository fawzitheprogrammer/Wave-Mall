...
import 'package:wave_mall_user/features/support/widget/priority_bottom_sheet.dart';
              ...
              Padding(
                  ...
                  child: InkWell(
                      onTap: () => showModalBottomSheet(
                          ...
                          context: context,
                          builder: (_) => const PriorityBottomSheet()),
                      child: Container(
              ...
              GridView.builder(
                ...
                itemBuilder: (BuildContext context, index) {
                  return index ==
                      ...
                      ? InkWell(
                          onTap: () => supportTicketProvider.pickMultipleImage(
                            false,
                          ),
                          child: DottedBorder(
                              strokeWidth: 2,
