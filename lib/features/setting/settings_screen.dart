...
import 'package:wave_mall_user/basewidget/custom_expanded_app_bar.dart';
import 'package:wave_mall_user/basewidget/select_currency_bottom_sheet.dart';
import 'package:wave_mall_user/basewidget/select_language_bottom_sheet.dart';
                  ...
                  children: [
                    ...
                    TitleButton(
                      ...
                      onTap: () => showModalBottomSheet(
                        ...
                        context: context,
                        builder: (_) => const SelectLanguageBottomSheet(),
                      ),
                    ),
                    ...
                    TitleButton(
                      ...
                      onTap: () => showModalBottomSheet(
                        ...
                        isScrollControlled: true,
                        context: context,
                        builder: (_) => const SelectCurrencyBottomSheet(),
                      ),
                    ),
                  ],
                ),
