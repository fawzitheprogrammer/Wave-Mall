...
import 'package:wave_mall_user/features/search/widget/search_filter_bottom_sheet.dart';
              ...
              child: PaginatedListView(
                  ...
                  onPaginate: (offset) async {
                    await searchProductProvider.searchProduct(
                        query: searchProductProvider.searchController.text,
                        offset: offset!);
                  },
                  ...
                  itemView: MasonryGridView.count(
                    ...
                    shrinkWrap: true,
                    itemCount:
                        searchProductProvider.searchedProduct!.products!.length,
