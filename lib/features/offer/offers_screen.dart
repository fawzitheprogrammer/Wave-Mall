      ...
      body: Consumer<BannerController>(
        builder: (context, banner, child) {
          return banner.footerBannerList != null
              ? banner.footerBannerList!.isNotEmpty
                  ? RefreshIndicator(
                      onRefresh: () async =>
                          await Provider.of<BannerController>(context,
                                  listen: false)
                              .getBannerList(true),
                      child: ListView.builder(
                          padding:
                              const EdgeInsets.all(Dimensions.paddingSizeSmall),
                          itemCount: Provider.of<BannerController>(context)
                              .footerBannerList!
                              .length,
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Shimmer.fromColors(
          ...
          enabled:
              Provider.of<BannerController>(context).footerBannerList == null,
          child: Container(
            height: 100,
