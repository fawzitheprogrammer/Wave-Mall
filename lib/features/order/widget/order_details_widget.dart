...
import 'package:wave_mall_user/features/order/domain/model/order_details_model.dart';
...
import 'package:wave_mall_user/features/order/widget/refunded_status_bottom_sheet.dart';
import 'package:wave_mall_user/features/order/widget/review_dialog.dart';
import 'package:wave_mall_user/features/product/widget/refund_request_bottom_sheet.dart';
                        ...
                        children: [
                          ...
                          Row(children: [
                            ...
                            widget.orderDetailsModel.productDetails!.taxModel ==
                                    'exclude'
                                ? Text(
                                    '(${getTranslated('tax', context)} ${widget.orderDetailsModel.tax})',
                                    style: titilliumRegular.copyWith(
                                        color: ColorResources.hintTextColor,
                                        fontSize: Dimensions.fontSizeDefault),
                                  )
                                    ...
                                    return InkWell(
                                        onTap: () async {
                                          if (widget
                                            ...
                                            log("==url>${Provider.of<SplashProvider>(Get.context!, listen: false).baseUrls!.digitalProductUrl}/${widget.orderDetailsModel.productDetails!.digitalFileReady}");
                                            if (Provider.of<AuthController>(
                                              ...
                                              _launchUrl(Uri.parse(widget
                                                  ...
                                                  : '${Provider.of<SplashProvider>(Get.context!, listen: false).baseUrls!.digitalProductUrl}/${widget.orderDetailsModel.product?.digitalFileReady}'));
                                            } else {
                                              orderProvider
                              ...
                              children: [
                                ...
                                Consumer<OrderProvider>(
                                  ...
                                  return refund.orderTypeIndex == 1 &&
                                          widget.orderDetailsModel.refundReq ==
                                              0 &&
                                          widget.orderType != "POS"
                                      ? InkWell(
                                          onTap: () {
                                            ...
                                            refund
                                              ...
                                              if (value.response!.statusCode ==
                                                ...
                                                Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                        builder: (_) => RefundResultBottomSheet(
                                                            product: widget
                                                                .orderDetailsModel
                                                                .productDetails,
                                                            orderDetailsId: widget
