...
import 'package:flutter_sixvalley_ecommerce/features/order/domain/model/order_details_model.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/order/widget/refunded_status_bottom_sheet.dart';
import 'package:flutter_sixvalley_ecommerce/features/order/widget/review_dialog.dart';
import 'package:flutter_sixvalley_ecommerce/features/product/widget/refund_request_bottom_sheet.dart';
              ...
              Row(children: [const Spacer(),
                ...
                Consumer<OrderProvider>(builder: (context, orderProvider, _) {
                  return InkWell(onTap : () async {
                    ...
                    }else if(widget.orderDetailsModel.productDetails!.digitalProductType == "digital_file_ready" && widget.orderDetailsModel.product == null){
                      showCustomSnackBar(getTranslated("contact_with_support", context), context);
                    }
                    else{
                      log("==url>${Provider.of<SplashProvider>(Get.context!, listen: false).
                    ...
                    child: Container(width: 100, padding: const EdgeInsets.only(left: 5),
                  ...
                  child: Row(children: [
                    ...
                    InkWell(onTap: () {
                      ...
                      child: Container(height: 30,
                        decoration: BoxDecoration(color:  Colors.deepOrangeAccent, borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall),),
                        child: Row(children: [
