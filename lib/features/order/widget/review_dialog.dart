              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                    Center(
                        child: Text(getTranslated('rate_the_quality', context)!,
                    ...
                    CustomTextField(
                      maxLines: 4,
                      hintText:
                          getTranslated('write_your_experience_here', context),
                            ...
                            itemBuilder: (BuildContext context, index) {
                              return index == orderProvider.reviewImages.length
                                  ? Padding(
                                      ...
                                      child: InkWell(
                                        onTap: () => orderProvider
                                            .pickImage(false, fromReview: true),
                                        child: DottedBorder(
                                          strokeWidth: 2,
                                  ...
                                  : Stack(
                                      children: [
                                        ...
                                        Positioned(
                                          ...
                                          child: InkWell(
                                            onTap: () =>
                                                orderProvider.removeImage(index,
                                                    fromReview: true),
                                            child: Container(
                                                decoration: const BoxDecoration(
                                                    color: Colors.white,
                              ...
                              onTap: () {
                                if (Provider.of<ProductDetailsProvider>(context,
                                  ...
                                  Provider.of<ProductDetailsProvider>(context,
                                          listen: false)
                                      .setErrorText(
                                          '${getTranslated('add_a_rating', context)}');
...
class OrderDetails extends StatefulWidget {
  ...
  final String orderType;
  const OrderDetails(
      {super.key, required this.orderDetailsModel, required this.orderType});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        ...
                        style: titilliumRegular.copyWith(
                            color: ColorResources.hintTextColor, fontSize: 14)),
                    const SizedBox(height: Dimensions.marginSizeExtraSmall),
