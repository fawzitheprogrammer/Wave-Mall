              ...
              return Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        refundReq.refundResultModel != null &&
                                refundReq.refundResultModel!.refundRequest !=
                                    null
                            ? Text(
                                '${getTranslated('refund_id', context)}${refundReq.refundResultModel!.refundRequest!.first.id}',
                        ...
                        Consumer<OrderProvider>(builder: (context, refund, _) {
                          return refund.refundResultModel != null &&
                                  refund.refundResultModel!.refundRequest !=
                                      null
                              ? Padding(
