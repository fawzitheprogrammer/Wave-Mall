...
import 'package:wave_mall_user/features/order/domain/model/order_model.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => OrderDetailsScreen(orderId: orderModel!.id)));
      },
      child: Stack(
        children: [
          Container(
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          ...
                          height: 80,
                          image:
                              '${Provider.of<SplashProvider>(context, listen: false).configModel?.baseUrls?.shopImageUrl}/${orderModel?.seller?.shop?.image}',
                    ...
                    child: Column(
                        ...
                        children: [
                          Row(children: [
                            Expanded(
                                child: Text(
                                    '${getTranslated('order', context)!}# ${orderModel!.id.toString()}',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: orderModel!.orderStatus == 'delivered'
                        ? ColorResources.getGreen(context).withOpacity(.10)
                        : orderModel!.orderStatus == 'pending'
                            ? ColorResources.getYellow(context).withOpacity(.10)
                            : orderModel!.orderStatus == 'confirmed'
                                ? ColorResources.getFloatingBtn(context)
                                    .withOpacity(.10)
          ...
          Positioned(
              ...
              child: Container(
                  ...
                  child: Text("${orderModel?.orderDetailsCount}",
