...
import 'package:wave_mall_user/features/home/shimmer/order_details_shimmer.dart';
import 'package:wave_mall_user/features/order/widget/cal_chat_widget.dart';
import 'package:wave_mall_user/features/order/widget/cancel_and_support_center.dart';
import 'package:wave_mall_user/features/order/widget/order_details_top_portion_widget.dart';
import 'package:wave_mall_user/features/order/widget/ordered_product_list.dart';
import 'package:wave_mall_user/features/order/widget/payment_info.dart';
import 'package:wave_mall_user/features/order/widget/seller_section.dart';
import 'package:wave_mall_user/features/order/widget/shipping_and_billing_widget.dart';
import 'package:wave_mall_user/features/order/widget/shipping_info.dart';
...
import 'package:wave_mall_user/basewidget/amount_widget.dart';
          ...
          appBar: AppBar(
              ...
              title:
                ...
                return (orderProvider.orderDetails != null &&
                    ...
                    ? OrderDetailTopPortion(
                        orderProvider: orderProvider,
                        fromNotification: widget.isNotification)
                    : const SizedBox();
              })),
                  ...
                  ? Consumer<OrderProvider>(
                      builder: (context, orderProvider, child) {
                        ...
                        if (orderProvider.orderDetails != null &&
                          ...
                          if (orderProvider
                                  .orderDetails?[0].order?.isShippingFree ==
                              1) {
                            shippingCost = 0;
                          } else {
                            shippingCost =
                            ...
                            ? ListView(
                                ...
                                children: [
                                  ...
                                  ShippingAndBillingWidget(
                                      orderProvider: orderProvider),
                                  orderProvider.orders != null &&
                                          orderProvider.orders!.orderNote !=
                                              null
                                      ? Padding(
                                  ...
                                  if (orderProvider.orders != null)
                                    OrderProductList(
                                      order: orderProvider,
                                      orderType:
                                          orderProvider.orders!.orderType,
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.fromLTRB(
                                                ...
                                                Dimensions
                                                    .paddingSizeExtraSmall),
                                            child: Text(
                                              '${getTranslated('picture_uploaded_by', context)} ${orderProvider.orders!.deliveryMan != null ? '${orderProvider.orders!.deliveryMan!.fName} ${orderProvider.orders!.deliveryMan!.lName}' : ''}',
                                                      ...
                                                      onTap: () {
                                                        showDialog(
                                                            ...
                                                            builder: (_) =>
                                                                ImageDialog(
                                                                    imageUrl:
                                                                        '${AppConstants.baseUrl}/storage/app/public/delivery-man/verification-image/'
                                                                        '${orderProvider.orderDetails![0].verificationImages?[index].image}'));
                                                      },
                                                      child: Padding(
                                                                ...
                                                                borderRadius:
                                                                    BorderRadius.circular(
                                                                        Dimensions
                                                                            .paddingSizeSmall),
                                                                child: Container(
                                                                    decoration: BoxDecoration(border: Border.all(color: Theme.of(context).primaryColor.withOpacity(.25), width: .25), borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall)),
                                                                    child: CustomImage(
                                                                        image: '${AppConstants.baseUrl}/storage/app/public/delivery-man/verification-image/'
                                                                            '${orderProvider.orderDetails![0].verificationImages?[index].image}')),
                                                              ))),
                                                    );
                                                  }))
