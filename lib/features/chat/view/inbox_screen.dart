...
import 'package:wave_mall_user/features/chat/widget/chat_item_widget.dart';
import 'package:wave_mall_user/features/chat/widget/chat_type_button.dart';
import 'package:wave_mall_user/features/chat/widget/inbox_shimmer.dart';
import 'package:wave_mall_user/features/chat/widget/search_inbox_widget.dart';
                      ...
                      builder: (context, chatProvider, child) {
                        return chatProvider.chatModel != null
                            ? (chatProvider.chatModel!.chat != null &&
                                ...
                                ? ListView.builder(
                                    itemCount:
                                        chatProvider.chatModel?.chat?.length,
