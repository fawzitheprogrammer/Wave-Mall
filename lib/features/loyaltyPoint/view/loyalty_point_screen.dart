...
import 'package:wave_mall_user/features/loyaltyPoint/widget/loyalty_point_converter_dialogue.dart';
import 'package:wave_mall_user/features/loyaltyPoint/widget/loyalty_point_list.dart';
import 'package:wave_mall_user/features/loyaltyPoint/widget/loyalty_point_top_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: RefreshIndicator(
            ...
            onRefresh: () async =>
                Provider.of<LoyaltyPointProvider>(context, listen: false)
                    .getLoyaltyPointList(context, 1, reload: true),
                  ...
                  onTap: () {
                    showDialog(
                        ...
                        builder: (context) => Dialog(
                            ...
                            child: LoyaltyPointConverterDialogue(
                                myPoint:
