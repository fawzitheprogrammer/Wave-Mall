...
import 'package:wave_mall_user/features/loyaltyPoint/widget/how_to_use_dialog.dart';
...
class LoyaltyPointConverterDialogue extends StatefulWidget {
  ...
  @override
  State<LoyaltyPointConverterDialogue> createState() =>
      _LoyaltyPointConverterDialogueState();
}

class _LoyaltyPointConverterDialogueState
    extends State<LoyaltyPointConverterDialogue> {
  double convertPointAmount = 0;
  final TextEditingController _convertPointAmountController =
      TextEditingController();

  @override
  Widget build(BuildContext context) {
    double? exchangeRate = Provider.of<SplashProvider>(context, listen: false)
        .configModel!
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Card(
                    ...
                    child: Padding(
                        ...
                        child: Column(children: [
                          Text(
                              '${getTranslated('convert_point_to_wallet_money', context)}',
                          ...
                          CustomTextField(
                              ...
                              onChanged: (value) {
                                setState(() {
                                  convertPointAmount =
                                      double.parse(value) / exchangeRate!;
                                });
                              }),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          Text(
                              '${getTranslated('converted_amount', context)} = ${PriceConverter.convertPrice(context, convertPointAmount)}',
                              style: textRegular.copyWith(
                                  color: Theme.of(context).primaryColor,
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          PointWithTextWidget(
                              ...
                              text:
                                  '${getTranslated('minimum_exchange_point_is', context)} $min'),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          PointWithTextWidget(
                              pointColor: ColorResources.getTextTitle(context),
                          ...
                          PointWithTextWidget(
                              pointColor: ColorResources.getTextTitle(context),
                              text:
                                  '$exchangeRate ${getTranslated('note_point_two', context)} ${PriceConverter.convertPrice(context, 1)}'),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          PointWithTextWidget(
                              pointColor: ColorResources.getTextTitle(context),
                              text:
                                  getTranslated('note_point_three', context)!),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          PointWithTextWidget(
                              pointColor: ColorResources.getTextTitle(context),
                ...
                Consumer<LoyaltyPointProvider>(builder: (context, convert, _) {
                          ...
                          child: CustomButton(
                            ...
                            onTap: () {
                              ...
                              if (point < min!) {
                                ...
                                showCustomSnackBar(
                                    '${getTranslated('minimum_point_is', context)!} $min',
                                    context,
                                    isToaster: true);
