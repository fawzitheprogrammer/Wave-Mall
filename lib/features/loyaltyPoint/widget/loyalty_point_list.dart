...
import 'package:wave_mall_user/features/loyaltyPoint/domain/model/loyalty_point_model.dart';
...
import 'package:wave_mall_user/features/loyaltyPoint/widget/loyalty_point_widget.dart';
    ...
    scrollController?.addListener(() {
      if (scrollController!.position.maxScrollExtent ==
          ...
          !Provider.of<LoyaltyPointProvider>(context, listen: false)
              .isLoading) {
        int? pageSize;
        pageSize = Provider.of<LoyaltyPointProvider>(context, listen: false)
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (ctx, index) {
                            return LoyaltyPointWidget(
                                ...
                                index: index,
                                length: loyaltyPointList.length);
                          }))
                  : Padding(
