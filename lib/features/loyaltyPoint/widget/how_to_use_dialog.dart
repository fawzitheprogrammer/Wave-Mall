      ...
      child: Column(
        ...
        children: [
          ...
          PointWithTextWidget(
              ...
              textColor: Colors.grey,
              text:
                  '${getTranslated('minimum', context)} ${Provider.of<SplashProvider>(context, listen: false).configModel?.loyaltyPointMinimumPoint} ${getTranslated('how_to_use_point_two', context)!}'),
      ...
      children: [
        ...
        Padding(
            ...
            child: Container(
                ...
                height: 5,
                decoration:
                    BoxDecoration(shape: BoxShape.circle, color: pointColor))),
