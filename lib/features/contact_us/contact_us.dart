...
class _ContactUsScreenState extends State<ContactUsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          centerTitle: true, title: '${getTranslated('contact_us', context)}'),
            ...
            child: Column(
              children: [
                SizedBox(
                    ...
                    child: Image.asset(Images.contactUsBg)),
                CustomTextField(
        ...
        return Padding(
          ...
          child: CustomButton(
            ...
            onTap: () {
              ...
              if (name.isEmpty) {
                showCustomSnackBar(
                    '${getTranslated('name_is_required', context)}', context);
                ...
                showCustomSnackBar(
                    '${getTranslated('message_is_required', context)}',
                    context);
              } else {
                profileProvider
