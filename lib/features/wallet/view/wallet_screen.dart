...
import 'package:wave_mall_user/helper/date_converter.dart';
...
import 'package:wave_mall_user/basewidget/transaction_filter_bottom_sheet.dart';
import 'package:wave_mall_user/features/home/view/aster_theme_home_page.dart';
import 'package:wave_mall_user/features/home/shimmer/wallet_bonus_shimmer.dart';
import 'package:wave_mall_user/features/wallet/widget/transaction_list_view.dart';
import 'package:wave_mall_user/features/wallet/widget/wallet_card_widget.dart';
...
class _WalletScreenState extends State<WalletScreen> {
  ...
  bool darkMode =
      Provider.of<ThemeProvider>(Get.context!, listen: false).darkTheme;
  bool isGuestMode =
                  ...
                  children: [
                    isGuestMode
                        ...
                        : Column(children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.only(
                                  top: Dimensions.paddingSizeSmall, bottom: 50),
                              child: Consumer<WalletTransactionProvider>(
                                  builder: (context, walletProvider, _) {
                                return walletProvider.walletBonusModel != null
                                    ? (walletProvider.walletBonusModel!
                                                    .bonusList !=
                                                null &&
                                            walletProvider.walletBonusModel!
                                                .bonusList!.isNotEmpty)
                                        ? Stack(
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Text(
                                                                    '${walletProvider.walletBonusModel?.bonusList?[index].title}',
                                                                ...
                                                                if (walletProvider
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Text(
                                                                        '${getTranslated('valid_till', context)} ${DateConverter.dateTimeStringToDateTime(walletProvider.walletBonusModel!.bonusList![index].endDateTime!)}',
                                                                    ...
                                                                    : Padding(
                                                                        padding: const EdgeInsets
                                                                            ...
                                                                            vertical:
                                                                                Dimensions.paddingSizeSmall),
                                                                        child: Text(
                                                                            '${getTranslated('add_fund_to_wallet', context)} ${PriceConverter.convertPrice(context, walletProvider.walletBonusModel!.bonusList![index].minAddMoneyAmount)} ${getTranslated('and', context)} ${getTranslated('enjoy', context)} ${walletProvider.walletBonusModel!.bonusList![index].bonusAmount}% ${getTranslated('bonus', context)}'),
                                                                      ),
                                                                Text(
                                                                    '${walletProvider.walletBonusModel?.bonusList?[index].description}',
                                                                    maxLines: 2,
                                                                    overflow:
                                                                        TextOverflow
                                                                            .ellipsis,
