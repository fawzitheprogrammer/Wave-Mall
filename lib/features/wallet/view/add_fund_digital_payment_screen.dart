...
class AddFundToWalletDigitalPayment extends StatefulWidget {
  final String url;

  const AddFundToWalletDigitalPayment({super.key, required this.url});

  @override
  PaymentScreenState createState() => PaymentScreenState();
}

class PaymentScreenState extends State<AddFundToWalletDigitalPayment> {
  String? selectedUrl;
  double value = 0.0;
