...
import 'package:wave_mall_user/features/auth/widgets/reset_password_widget.dart';
...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Consumer<SplashProvider>(builder: (context, splashProvider, _) {
                              ...
                              if (widget.fromForgetPassword) {
                                ...
                                authProvider
                                  ...
                                  if (value.response?.statusCode == 200) {
                                    _startTimer();
                                    showCustomSnackBar(
                                        '${getTranslated('otp_resent_successfully', context)}',
                                        context,
                                        isError: false);
                                  }
                                });
