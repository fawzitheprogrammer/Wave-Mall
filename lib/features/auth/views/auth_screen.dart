...
import 'package:wave_mall_user/features/auth/widgets/sign_in_widget.dart';
import 'package:wave_mall_user/features/auth/widgets/sign_up_widget.dart';
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvoked: (val) async {
        if (Provider.of<AuthController>(context, listen: false).selectedIndex !=
            0) {
          Provider.of<AuthController>(context, listen: false)
                ...
                Stack(children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset(Images.logoImage, width: 130, height: 100)
                      ],
                    ),
                  )
                ]),
