...
import 'package:wave_mall_user/features/address/widgets/address_type_widget.dart';
...
class SavedBillingAddressListScreen extends StatefulWidget {
  ...
  @override
  State<SavedBillingAddressListScreen> createState() =>
      _SavedBillingAddressListScreenState();
}

class _SavedBillingAddressListScreenState
    extends State<SavedBillingAddressListScreen> {
  @override
      ...
      body: SafeArea(child: Consumer<AddressController>(
        builder: (context, locationProvider, child) {
          return SingleChildScrollView(
            child: Column(
              children: [
                locationProvider.billingAddressList.isNotEmpty
                    ? SizedBox(
                        child: ListView.builder(
                            physics: const NeverScrollableScrollPhysics(),
                            itemCount:
                                locationProvider.billingAddressList.length,
                            shrinkWrap: true,
                    ...
                    : Padding(
                        ...
                        child: Center(
                            child: Container(
                                ...
                                child: const NoInternetOrDataScreen(
                                    isNoInternet: false,
