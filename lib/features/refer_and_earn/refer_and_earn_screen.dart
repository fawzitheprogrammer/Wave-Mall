...
import 'package:wave_mall_user/features/refer_and_earn/widgets/refer_hint_view.dart';
                              ...
                              GestureDetector(
                                  onTap: () {
                                    Clipboard.setData(ClipboardData(
                                        text: Provider.of<ProfileProvider>(
                                                    context,
                                                    listen: false)
                                                .userInfoModel
                                                ?.referCode ??
                        ...
                        child: Row(
                            ...
                            children: shareItem
                                .map((item) => GestureDetector(
                                      onTap: () => Share.share(
                                        'Greetings, SwiftTech is the best e-commerce platform in the country. If you are new to this website don’t forget to use "${Provider.of<ProfileProvider>(context, listen: false).userInfoModel?.referCode ?? ''}" as the referral code while sign up into SwiftTech. ${'${Provider.of<SplashProvider>(context, listen: false).configModel?.refSignup}${Provider.of<ProfileProvider>(context, listen: false).userInfoModel?.referCode ?? ''}'}',
                                      ),
                                      child: Container(
