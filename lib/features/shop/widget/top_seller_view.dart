...
import 'package:wave_mall_user/features/shop/widget/seller_card.dart';
                ...
                ? ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return SizedBox(
                          ...
                          child: SellerCard(
                              sellerModel:
                                  topSellerProvider.topSellerList![index],
                              isHomePage: isHomePage,
                              index: index,
                              length: topSellerProvider.topSellerList!.length));
                    },
                  )
                : const SizedBox()
          ...
          child:
            ...
            Expanded(
              ...
              child: Shimmer.fromColors(
                ...
                enabled:
                    (Provider.of<TopSellerProvider>(context).topSellerList ==
                        null),
                child: Container(
