  ...
  Widget build(BuildContext context) {
    return Consumer<ProductProvider>(builder: (context, productProvider, _) {
      return productProvider.sellerWiseFeaturedProduct != null
          ? (productProvider.sellerWiseFeaturedProduct!.products != null &&
                  productProvider
              ...
              ? PaginatedListView(
                  ...
                  totalSize:
                      productProvider.sellerWiseFeaturedProduct?.totalSize,
              ...
              : const SizedBox()
          : ProductShimmer(
              isEnabled: productProvider.sellerWiseFeaturedProduct == null,
              isHomePage: false);
    });
  }
}
