...
import 'package:wave_mall_user/basewidget/guest_dialog.dart';
import 'package:wave_mall_user/features/chat/view/chat_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        CustomImage(
          image:
              '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/banner/$banner',
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                    ...
                    child: ClipRRect(
                        ...
                        child: CustomImage(
                            ...
                            fit: BoxFit.cover,
                            image:
                                '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/$shopImage'))),
              ...
              Expanded(
                child: Consumer<SellerProvider>(
                  ...
                  String ratting = sellerProvider.sellerModel != null &&
                          sellerProvider.sellerModel!.avgRating != null
                                      ...
                                      child: Row(children: [
                                        ...
                                        if (sellerProvider.sellerModel!
                                            ...
                                            sellerProvider.sellerModel!
                                                ...
                                                0)
                                          Text(
                                            '${sellerProvider.sellerModel!.totalReview} ${getTranslated('reviews', context)}',
                                    ...
                                    children: [
                                      (sellerProvider.sellerModel!
                                              ...
                                              sellerProvider.sellerModel!
                                                  ...
                                                  0)
                                          ? Text(
                                              '${PriceConverter.convertPrice(context, sellerProvider.sellerModel!.minimumOrderAmount)} ${getTranslated('minimum_order', context)}',
                                              style: titleRegular.copyWith(
                                                  fontSize:
                                                      Dimensions.fontSizeSmall,
                                                  color: Theme.of(context)
                                      ...
                                      Text(
                                        '${sellerProvider.sellerModel!.totalProduct} ${getTranslated('products', context)}',
                                        style: titleRegular.copyWith(
