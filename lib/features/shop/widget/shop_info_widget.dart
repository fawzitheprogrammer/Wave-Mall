...
import 'package:flutter_sixvalley_ecommerce/basewidget/guest_dialog.dart';
        ...
        Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
          child: Container(transform: Matrix4.translationValues(0, -20, 0),
            ...
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),
                ...
                null:[BoxShadow(color: Colors.grey.withOpacity(0.3), spreadRadius: 1, blurRadius: 5)]),
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Stack(children: [
                ...
                if(temporaryClose || vacationIsOn)
                  Container(width: 80,height: 80, decoration: BoxDecoration(color: Colors.black.withOpacity(.5),
