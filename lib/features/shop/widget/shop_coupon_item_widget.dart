          ...
          ClipRRect(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  boxShadow: Provider.of<ThemeProvider>(context, listen: false)
                          .darkTheme
                      ? null
                      : [
                          BoxShadow(
                                    ...
                                    : Padding(
                                        padding: const EdgeInsets.symmetric(
                                            vertical:
                                                Dimensions.paddingSizeSmall),
                                        child: Text(
                                          '${PriceConverter.convertPrice(context, coupons.discount)} ${getTranslated('OFF', context)}',
                                          style: robotoBold.copyWith(
                                              fontSize:
                                                  Dimensions.fontSizeExtraLarge,
                                              color: Theme.of(context)
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.symmetric(
                                  vertical: Dimensions.paddingSizeSmall),
                              child: Text(
                                  '${getTranslated('available_till', context)} ${DateConverter.estimatedDate(DateTime.parse(coupons.expireDatePlanText!))}',
                                  style: textRegular.copyWith()),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(
                              ...
                              child: Text(
                                  '${getTranslated('minimum_purchase_amount', context)} ${PriceConverter.convertPrice(context, coupons.minPurchase)}',
                                  style: textRegular.copyWith(
                                      fontSize: Dimensions.fontSizeSmall)),
                            ),
                          ],
