...
import 'package:wave_mall_user/features/shop/widget/shop_coupon_item_widget.dart';
import 'package:wave_mall_user/features/shop/widget/shop_featured_product_list_view.dart';
import 'package:wave_mall_user/features/shop/widget/shop_recommanded_product_list.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CouponProvider>(builder: (context, couponProvider, _) {
      return ListView(
        ...
        shrinkWrap: true,
        children: [
          couponProvider.couponItemModel != null
              ? (couponProvider.couponItemModel!.coupons != null &&
                      couponProvider.couponItemModel!.coupons!.isNotEmpty)
                  ? SizedBox(
                      width: width,
                      height: MediaQuery.of(context).size.width * .85,
                      child: couponProvider.couponItemModel != null
                          ? (couponProvider.couponItemModel!.coupons != null &&
                                  couponProvider
                                  ...
                                  children: [
                                    CarouselSlider.builder(
                                      ...
                                      itemBuilder: (context, index, _) {
                                        return SizedBox(
                                            child: ShopCouponItem(
                                          coupons: couponProvider
                                    ...
                                    Positioned(
                                        ...
                                        child: Row(
                                            ...
                                            children: couponProvider
                                                .couponItemModel!.coupons!
                                                .map((banner) {
                                              int index = couponProvider
                                                  .couponItemModel!.coupons!
                                                  .indexOf(banner);
                                    ...
                                    Positioned(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                            '${couponProvider.couponCurrentIndex + 1}',
                                            style: textMedium.copyWith(
                                                color: Theme.of(context)
                                                    .primaryColor),
                                          ),
                                          Text(
                                            '/${couponProvider.couponItemModel!.coupons!.length}',
                          ...
                          : Shimmer.fromColors(
                              ...
                              enabled:
                                  couponProvider.couponItemModel!.coupons ==
                                      null,
                              child: Container(
          ...
          Consumer<ProductProvider>(builder: (context, productProvider, _) {
            return Padding(
                padding: const EdgeInsets.fromLTRB(
                    ...
                    0),
                child: TitleRow(
                    title: productProvider.sellerWiseFeaturedProduct != null
                        ? (productProvider
                                        .sellerWiseFeaturedProduct!.products !=
                                    null &&
                                productProvider.sellerWiseFeaturedProduct!
                                    .products!.isNotEmpty)
          ...
          Consumer<ProductProvider>(builder: (context, productProvider, _) {
            return (productProvider.sellerWiseFeaturedProduct != null &&
                    productProvider.sellerWiseFeaturedProduct!.products !=
                        null &&
                    productProvider
